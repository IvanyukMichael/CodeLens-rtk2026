...
docstring, code, enriched_text. Конфигурация ретрива:
bge-m3 + enriched (P@5=0.800 офиц.15 / 0.831 расш.71 с HyDE-mix temp=0 на
стороне запроса) — здесь мы эмбеддим РОВНО тот же enriched-текст, что в
